...
#SBATCH --job-name="abf"
#SBATCH --array=1%1
# SBATCH --depend=afterany:102397
#----------------
# for an arrayID=1, the replica job is 0
# number of replica jobs != number of replicas
# array number is number of jobs, not number of replicas
...
#------------------------------------------------------
# Set variables related to NAMD ABF job
#------------------------------------------------------
